---
title: "Simulation study with multiple runs"
author: "Eric Fox"
...
# set directories
home_dir <- '/Users/ericfox/Documents/epa/'
proj_dir <- paste0(home_dir, 'mmigeostat_proj/mmigeostat2/')
loc_dir <- paste0(proj_dir, 'inst/simulation/sim20runs/loc_data/')
...
sim_results <-  as.data.frame(matrix(999.9, nrow=8, ncol=14))
names(sim_results) <- c('NL_L', 'Rsqr', 'nugg', 'parsil', 'a', 'c', 
  'lm_rmse', 'lm_cov90', 'slm_rmse', 'slm_cov90', 
  'rf_rmse', 'rf_cov90', 'rfrk_rmse', 'rfrk_cov90')
rownames(sim_results) <- paste0('case', c(1:8))
sim_results$NL_L <- rep(c('NL', 'L'), each=4)
sim_results$Rsqr <- rep(c(0.1, 0.9), each=2, length.out = 8)
sim_results$nugg <- rep(c(9,1), 4)
sim_results$parsil <- rep(c(1,9), 4)
```
...
```{r, eval=T, echo=T}
sim_results[1, c("a", "c", "lm_rmse", "lm_cov90", "slm_rmse", "slm_cov90", 
  "rf_rmse", "rf_cov90", "rfrk_rmse", "rfrk_cov90")] <- 
  sapply(list(a1, c1, lm1_rmse, lm1_cov90, splm1_rmse, splm1_cov90, 
    rf1_rmse, rf1_cov90, rfrk1_rmse, rfrk1_cov90), mean)
```
...
```{r, eval=T, echo=T}
sim_results[2, c("a", "c", "lm_rmse", "lm_cov90", "slm_rmse", "slm_cov90", 
  "rf_rmse", "rf_cov90", "rfrk_rmse", "rfrk_cov90")] <- 
  sapply(list(a2, c2, lm2_rmse, lm2_cov90, splm2_rmse, splm2_cov90, 
    rf2_rmse, rf2_cov90, rfrk2_rmse, rfrk2_cov90), mean)
```
...
```{r, eval=T, echo=T}
sim_results[3, c("a", "c", "lm_rmse", "lm_cov90", "slm_rmse", "slm_cov90", 
  "rf_rmse", "rf_cov90", "rfrk_rmse", "rfrk_cov90")] <- 
  sapply(list(a3, c3, lm3_rmse, lm3_cov90, splm3_rmse, splm3_cov90, 
    rf3_rmse, rf3_cov90, rfrk3_rmse, rfrk3_cov90), mean)
```
...
```{r, eval=T, echo=T}
sim_results[4, c("a", "c", "lm_rmse", "lm_cov90", "slm_rmse", "slm_cov90", 
  "rf_rmse", "rf_cov90", "rfrk_rmse", "rfrk_cov90")] <- 
  sapply(list(a4, c4, lm4_rmse, lm4_cov90, splm4_rmse, splm4_cov90, 
    rf4_rmse, rf4_cov90, rfrk4_rmse, rfrk4_cov90), mean)
```
...
```{r, eval=T, echo=T}
sim_results[5, c("a", "c", "lm_rmse", "lm_cov90", "slm_rmse", "slm_cov90", 
  "rf_rmse", "rf_cov90", "rfrk_rmse", "rfrk_cov90")] <- 
  sapply(list(a5, c5, lm5_rmse, lm5_cov90, splm5_rmse, splm5_cov90, 
    rf5_rmse, rf5_cov90, rfrk5_rmse, rfrk5_cov90), mean)
```
...
```{r, eval=T, echo=T}
sim_results[6, c("a", "c", "lm_rmse", "lm_cov90", "slm_rmse", "slm_cov90", 
  "rf_rmse", "rf_cov90", "rfrk_rmse", "rfrk_cov90")] <- 
  sapply(list(a6, c6, lm6_rmse, lm6_cov90, splm6_rmse, splm6_cov90, 
    rf6_rmse, rf6_cov90, rfrk6_rmse, rfrk6_cov90), mean)
```
...
```{r, eval=T, echo=T}
sim_results[7, c("a", "c", "lm_rmse", "lm_cov90", "slm_rmse", "slm_cov90", 
  "rf_rmse", "rf_cov90", "rfrk_rmse", "rfrk_cov90")] <- 
  sapply(list(a7, c7, lm7_rmse, lm7_cov90, splm7_rmse, splm7_cov90, 
    rf7_rmse, rf7_cov90, rfrk7_rmse, rfrk7_cov90), mean)
```
...
```{r, eval=T, echo=T}
sim_results[8, c("a", "c", "lm_rmse", "lm_cov90", "slm_rmse", "slm_cov90", 
  "rf_rmse", "rf_cov90", "rfrk_rmse", "rfrk_cov90")] <- 
  sapply(list(a8, c8, lm8_rmse, lm8_cov90, splm8_rmse, splm8_cov90, 
    rf8_rmse, rf8_cov90, rfrk8_rmse, rfrk8_cov90), mean)
```

# Results table
```{r, eval=T, echo=T}
kable(sim_results, digits=3)
# saveRDS(sim_results, file=paste0(loc_dir, 'sim_results.rds'))
```